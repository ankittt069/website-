...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "you meant to press YES right my lady?? 😓";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "my lady your hand must have slipped right? 🥹";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "pretty please my lady 🥺";
    yes.style.height = "90%";
    yes.style.width = "96%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "knew it hehehe 😽";
  yes.innerHTML = '<a href="https://https://www.facebook.com/icantreachyousoiimaginealone?mibextid=ZbWKwL/">wanna talk hehe?!</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
